...
const BookingForm = ({ userToken, isOpen, onClose, selectedEquipment }) => {
    ...
    const handlePayment = async (equipment_id, booking_id) => {
        ...
        try {
            const response = await fetch(`https://femrs.onrender.com/api/initiate-payment/${equipment_id}/${booking_id}/`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
            ...
            const options = {
                ...
                handler: async function (paymentResponse) {
                    try {
                        const verifyResponse = await fetch("https://femrs.onrender.com/api/verify-payment/", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                Authorization: `Bearer ${token}`,
                    ...
                    const successResponse = await fetch("https://femrs.onrender.com/api/payment-success/", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: `Bearer ${token}`,
